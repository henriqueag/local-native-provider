...
ALTER TABLE ONLY public."Sales_Staffs" DROP CONSTRAINT "Sales_Staffs_StoreId_fkey";
ALTER TABLE ONLY public."Sales_Staffs" DROP CONSTRAINT "Sales_Staffs_ManagerId_fkey";
ALTER TABLE ONLY public."Sales_Orders" DROP CONSTRAINT "Sales_Orders_StoreId_fkey";
ALTER TABLE ONLY public."Sales_Orders" DROP CONSTRAINT "Sales_Orders_StaffId_fkey";
ALTER TABLE ONLY public."Sales_Orders" DROP CONSTRAINT "Sales_Orders_CustomerId_fkey";
ALTER TABLE ONLY public."Sales_Order_Items" DROP CONSTRAINT "Sales_Order_Items_OrderId_fkey";
ALTER TABLE ONLY public."Sales_Order_Items" DROP CONSTRAINT "Sales_Order_Items_ItemId_fkey";
ALTER TABLE ONLY public."Production_Stocks" DROP CONSTRAINT "Production_Stocks_StoreId_fkey";
ALTER TABLE ONLY public."Production_Stocks" DROP CONSTRAINT "Production_Stocks_ProductId_fkey";
ALTER TABLE ONLY public."Production_Products" DROP CONSTRAINT "Production_Products_CategoryId_fkey";
ALTER TABLE ONLY public."Production_Products" DROP CONSTRAINT "Production_Products_BrandId_fkey";
ALTER TABLE ONLY public."Sales_Stores" DROP CONSTRAINT "Sales_Stores_pkey";
ALTER TABLE ONLY public."Sales_Staffs" DROP CONSTRAINT "Sales_Staffs_pkey";
ALTER TABLE ONLY public."Sales_Staffs" DROP CONSTRAINT "Sales_Staffs_Email_key";
ALTER TABLE ONLY public."Sales_Orders" DROP CONSTRAINT "Sales_Orders_pkey";
ALTER TABLE ONLY public."Sales_Order_Items" DROP CONSTRAINT "Sales_Order_Items_pkey";
ALTER TABLE ONLY public."Sales_Customers" DROP CONSTRAINT "Sales_Customers_pkey";
ALTER TABLE ONLY public."Production_Stocks" DROP CONSTRAINT "Production_Stocks_pkey";
ALTER TABLE ONLY public."Production_Products" DROP CONSTRAINT "Production_Products_pkey";
ALTER TABLE ONLY public."Production_Categories" DROP CONSTRAINT "Production_Categories_pkey";
ALTER TABLE ONLY public."Production_Brands" DROP CONSTRAINT "Production_Brands_pkey";
ALTER TABLE public."Sales_Stores" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE public."Sales_Staffs" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE public."Sales_Orders" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE public."Sales_Customers" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE public."Production_Products" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE public."Production_Categories" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE public."Production_Brands" ALTER COLUMN "Id" DROP DEFAULT;
DROP VIEW public.store_stock_detailed;
DROP VIEW public.sales_orders_detailed;
DROP VIEW public.sales_order_items_detailed;
DROP SEQUENCE public."Sales_Stores_Id_seq";
DROP TABLE public."Sales_Stores";
DROP SEQUENCE public."Sales_Staffs_Id_seq";
DROP TABLE public."Sales_Staffs";
DROP SEQUENCE public."Sales_Orders_Id_seq";
DROP TABLE public."Sales_Orders";
DROP TABLE public."Sales_Order_Items";
DROP SEQUENCE public."Sales_Customers_Id_seq";
DROP TABLE public."Sales_Customers";
DROP TABLE public."Production_Stocks";
DROP SEQUENCE public."Production_Products_Id_seq";
DROP TABLE public."Production_Products";
DROP SEQUENCE public."Production_Categories_Id_seq";
DROP TABLE public."Production_Categories";
DROP SEQUENCE public."Production_Brands_Id_seq";
DROP TABLE public."Production_Brands";
